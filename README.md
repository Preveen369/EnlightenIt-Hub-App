...
For detailed setup and development instructions for the frontend, refer to the [Client README](./client/README.md). For backend-specific instructions, refer to the [Server README](./server/README.md).
